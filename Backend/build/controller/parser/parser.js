...
const SymbolTable_1 = __importDefault(require("../../utils/Interpreter/Arbol/Symbol/SymbolTable")); // Tabla de SÃmbolos
...
const parse = (req, res) => {
    ...
    try {
        ...
        res.json({ consola: ast.getconsola(), errores: exports.listaErrores, simbolos: listaSimbolos, ast: arbol });
    }
    catch (err) {
        console.log(err);
